...
export default function Servidor() {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            setFormData({ nome: "", celular: "", matricula: "", cpf: "", email: "", status: false });
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <TextInput
                    placeholder="Digite o celular do servidor"
                    placeholderTextColor="#7C7C8A"
                    style={styles.input}
                ...
                <TextInput
                    placeholder="Digite o email do servidor"
                    placeholderTextColor="#7C7C8A"
                    style={styles.input}
            ...
            <View style={styles.tableContainer}>
                ...
                <View style={styles.tableHeader}>
                    ...
                    <Text style={[styles.tableHeaderText, { flex: 1 }]}>CPF</Text>
                     <Text style={[styles.tableHeaderText, { flex: 1 }]}>Codigo</Text>
                    ...
                    {loading ? (
                        ...
                        servidores.map((item) => (
                            <View key={String(item.id)} style={styles.tableRow}>
                                ...
                                <Text style={[styles.tableCell, { flex: 1 }]}>{item.codigo}</Text>
                                ...
                                <View style={[{ flex: 1.5, flexDirection: "row", justifyContent: "flex-end" }]}>
                                    <TouchableOpacity style={[styles.editButton, { marginRight: 8 }]} onPress={() => loadEditServidor(item.id)}>
                                        <Text style={styles.editButtonText}>Editar</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.deleteButton} onPress={() => handleDeleteServidor(item.id)}>
